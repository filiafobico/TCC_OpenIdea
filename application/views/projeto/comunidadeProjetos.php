...
<main class="mdl-layout__content">
    ...
    <section class="mdl-layout__tab-panel is-active" id="projetos">
        <div class="page-content">
            <div class="mdl-grid">
                <form method="post" action="<?= base_url('Projetos-Comunidade') ?>">
            <div class="mdl-grid">                    
               ...
               <div class="mdl-cell--3-offset"></div>
                ...
                <div class="mdl-cell mdl-cell--1-col">
                    <?php
                        $query = $this->db->query("SELECT id, nome FROM categoriaProjeto");
                ...
                <div class="mdl-cell mdl-cell--4-col">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        ...
                        <label class="mdl-textfield__label" for="nome" >Digite parte ou o nome inteiro do Projeto</label>
                    </div>
                </div>
                <div class="mdl-cell mdl-cell--1-col">
